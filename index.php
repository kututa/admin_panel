...
<a href="logout.php" class="theme-toggle">Logout</a>
...
<!-- /* end of  logout and user section */ -->

<style>
    /* logout and user section*/
    :root {
        --text-color: white; /* Default text color in dark mode */
        --background-color: black; /* Default background color in dark mode */
    }

    .light {
        --text-color: black; /* Text color in light mode */
        --background-color: white; /* Background color in light mode */
    }
